...
const PersonalBestsPrivacyPolicy = () => {
  return (
    <div>
      <Navbar />
      <div className="p-3">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Personal Bests, the software program provided
              by the Company.
            </p>
          </li>
          <li>
...
export default PersonalBestsPrivacyPolicy;
