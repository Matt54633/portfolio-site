...
const GradientShakerPrivacyPolicy = () => {
  return (
    <div>
      <Navbar />
      <div className="p-3">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Gradient Shaker, the software program provided
              by the Company.
            </p>
          </li>
          <li>
...
export default GradientShakerPrivacyPolicy;
